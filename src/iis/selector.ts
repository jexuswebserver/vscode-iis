...
import { numberShrinkThreshold, textConfigFileDescriptionDefault, textConfigFileLabelDefault, textConfigFileName, textConfigFileSelectedPostfix, textConfigFileShortLabelDefault, textConfigFileTooltipDefault } from "../util/constants";
/**
 *
 */
export class ConfigFileSelector {
    public static async findConfigDir(
        ...
        logger.appendLine(
            `[preview] Found ${textConfigFileName} in paths: ${JSON.stringify(pathStrings)}`
        );
